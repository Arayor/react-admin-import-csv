...
export declare function processFile(file: File | any, parseConfig?: ParseConfig): Promise<any[] | undefined>;
export declare function processXlsxFile(file: File): Promise<any[]>;

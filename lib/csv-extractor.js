...
exports.processCsvData = exports.getCsvData = exports.processCsvFile = exports.processXlsxFile = exports.processFile = void 0;
...
function processFile(file, parseConfig) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!file.name.endsWith('.xlsx')) return [3 /*break*/, 1];
                    return [2 /*return*/, processXlsxFile(file)];
                case 1: return [4 /*yield*/, getCsvData(file, parseConfig)];
                case 2:
                    csvData = _a.sent();
...
exports.processXlsxFile = processXlsxFile;
